...
public class desisoft_jsp_Account_jsp1542947554805 extends desisoft.server.JspBaseClass {
...
_ds_jsp_lnum = 11;
            ...
            out.println( "\'>" );
_ds_jsp_lnum = 12;
            out.println( "         <h2><center><I><font color=\"Blue\">Open Account Form</font></I></center><h2>   " );
_ds_jsp_lnum = 13;
            out.println( "         " );
_ds_jsp_lnum = 14;
...
_ds_jsp_lnum = 17;
            out.println( "\t      <TD><B>Choose Account Type:</b></TD>" );
_ds_jsp_lnum = 18;
            out.println( "\t         <TD>" );
_ds_jsp_lnum = 19;
...
_ds_jsp_lnum = 43;
            out.println( "            <TR bgcolor=\'#ECFAEB\'>" );
_ds_jsp_lnum = 44;
            out.println( "            <TD><B>Opening Deposit:</B></TD>" );
_ds_jsp_lnum = 45;
            out.println( "\t    \t    \t  <TD>" );
_ds_jsp_lnum = 46;
            out.println( "\t    \t    \t   <INPUT TYPE=\'text\' NAME=\'OpeningDepositField\' Value=\'\' SIZE=\'25\' placeholder=\'Enter Opening Deposite\'>" );
_ds_jsp_lnum = 47;
            out.println( "\t    \t    \t  </TD>" );
_ds_jsp_lnum = 48;
            out.println( "            </TR>" );
...
_ds_jsp_lnum = 55;
    ...
    static String[] _desisoft_jsp_dependencyList = { "Account.jsp" };
    static long [] _desisoft_jsp_dependencyModTimes = { 1542947540516L };
